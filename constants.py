...
CL_DESC_NODE_REMOVED = " - "+COLOR_SIBLING+"{0}"+COLOR_DEFAULT+" has been removed from "+CL_DESC_FILENAME+NL
CL_DESC_NODE_DOES_NOT_EXIST = " - "+COLOR_SIBLING+"{0}"+COLOR_DEFAULT+" was not found in "+CL_DESC_FILENAME+NL
